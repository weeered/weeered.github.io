...
function dropdownToggle(e) {
	...
	if (dropdownElem.children.length == 1) {
		...
		if (e.id == "choomButton") {
			menu.innerHTML =
				"<a href='./media/documents/participants_CC.pdf' target='blank'>📄O Кубке</a><a href='#' target='blank'>📄Регистрация на Кубок</a>";
		} else if (e.id == "corpoButton") {
			menu.innerHTML =
				"<a href='./media/documents/partners_CC.pdf' target='blank'>📄Партнерская программа</a><a href='#' target='blank'>📄Контакты Организатора</a>";
		}
		setTimeout(() => {
