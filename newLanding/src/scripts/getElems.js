...
const themesDotGradRunElems =
	document.getElementsByClassName("themes__list-dot");
const programmDotGradRunElems = document.getElementsByClassName(
	"programm__event-topic-dot",
);
const koDotGradRunElems = document.getElementsByClassName("ko__dot");
